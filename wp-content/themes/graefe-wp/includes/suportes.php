...
/* Adiciona tamanho de imagem para os Clientes */
add_image_size('cliente', 236, 178, true);

/* Adiciona tamanho de imagem para as Equipes */
add_image_size('equipe', 372, 361, true);

/* Adiciona Local de Menu */
function menus () {
	register_nav_menu('primary', __('Menu Principal', 'theme-slug'));
	register_nav_menu('footer_exame_esquerda', __('Exames Esquerda (Footer)', 'theme-slug'));
	register_nav_menu('footer_exame_direita', __('Exames Direita (Footer)', 'theme-slug'));
}
