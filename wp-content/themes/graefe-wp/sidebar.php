<aside id="sidebarBlog">
	...
	<div id="sidebarBlogInterno">
		...
		<?php if ( is_page(41) || is_search() || is_category() || is_tag()) : ?>

			<!-- Banner 1 -->

			<?php if(get_field('imagem_banner_1', 41)){ ?>

				<figure class="imagemSidebar">

					<?php if(get_field('link_banner_1', 41)){ ?>
						<a href="<?php the_field('link_banner_1', 41); ?>" <?php if(get_field('nova_guia_banner_1', 41)[0] == 'sim'){ ?> target="_blank" <?php } ?>>
					<?php } ?>

                        <?php getImagemObj(get_field('imagem_banner_1',41)['sizes'], '2048x2048', 'Banner') ?>
					<?php if(get_field('link_banner_1', 41)){ ?>
						</a>
					<?php } ?>
			...
			<?php if(get_field('imagem_banner_2', 41)){ ?>

				<figure class="imagemSidebar">

					<?php if(get_field('link_banner_2', 41)){ ?>
						<a href="<?php the_field('link_banner_2', 41); ?>" <?php if(get_field('nova_guia_banner_2', 41)[0] == 'sim'){ ?> target="_blank" <?php } ?>>
					<?php } ?>
                        <?php getImagemObj(get_field('imagem_banner_2',41)['sizes'], '2048x2048', 'Banner') ?>
